...
export default function RefutationsPage() {
  ...
  const primaryTitle = articles[0]?.open_title ?? articles[0]?.title ?? "مفهوم التوحيد بين التقرير الشرعي والانحراف الصوفي";
  const handleShare = () => {
          ...
          <div className={styles.paper}>
            <div className={styles.paperInner}>
              <header className={styles.paperHeader}>
                <div className={styles.paperBadge}>اسم الكاتب : {(articles[0]?.author_name ?? '').trim() || 'شبهات تحت المجهر'}</div>
