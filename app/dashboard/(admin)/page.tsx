...
import CountryAnalyticsSection from '@/app/components/analytics/CountryAnalyticsSection';
import DailyVisitsSection from '@/app/components/analytics/DailyVisitsSection';
...
export default function DashboardHome() {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      getHomeStats()
        .then(setStats)
        .catch(() => { /* ignore errors in background poll */ });
    }, 5000);
    ...
    <div>
      ...
      <div className={styles.dashboardGrid}>
        ...
        <div className={styles.statCard}>
          ...
          <div className={styles.statValue}>{stats?.articles_count ?? 0}</div>
        </div>
      </div>
