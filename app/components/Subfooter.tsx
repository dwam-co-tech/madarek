...
export default function Subfooter({
  ...
  const handleTranslate = () => {
    const url = makeAbsolutePdfUrl();
    const tUrl = `https://translate.google.com/translate?sl=auto&tl=${translateTo}&u=${encodeURIComponent(url)}`;
      ...
      <div className={styles.actionsArea} aria-label="إجراءات الصفحة">
        <div className={styles.actionsInner}>
          <div className={styles.actionsRow}>
            <button type="button" className={`${styles.tabItem} ${styles.tabPrint}`} onClick={handlePrint}>
            ...
            <a href={pdfHref} download className={`${styles.tabItem} ${styles.tabPdf}`}>
              <svg className={styles.tabIcon} viewBox="0 0 24 24" aria-hidden="true">
