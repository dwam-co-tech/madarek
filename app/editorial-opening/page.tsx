...
export default function EditorialOpening() {
  ...
  const primaryTitle = articles[0]?.open_title ?? articles[0]?.title ?? "افتتاحية العدد";
  const handleShare = () => {
          ...
          <div className={styles.paper}>
            <div className={styles.paperInner}>
              <header className={styles.paperHeader}>
                <div className={styles.paperBadge}>اسم الكاتب : {(articles[0]?.author_name ?? '').trim() || 'افتتاحية العدد'}</div>
